...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <h1 style="color: #333; font-weight: bold; margin-bottom: 10px; text-align: center;">🌟 Thank you for participating in our survey! 🌟</h1>
    ...
    <a href="http://learncreategrow.com.ng" style="margin: 20px 0; width: 80px;"><em>![Logo]( {{ asset('storage/logo.png') }} ) <!-- Add the path to your logo file --></em></a>
</div>
